// Build artifact copier retained from @openai/sites-vite-plugin 0.2.0
// (openai/sites#9). Authentication is implemented by RiteVenue itself.
...
export function sites():Plugin{
 ...
 return {
  ...
  async closeBundle(){
   ...
   const outputDirectory=resolve(root,'dist','.openai'),hostingConfig=resolve(root,'.openai','hosting.json'),drizzleSource=resolve(root,'drizzle');
