...
export default async function Admin(){const user=await requireAuthenticatedUser('/admin');if(!isAdmin(user))return <main className="content-page"><h1>Admin access required</h1><p>This workspace is restricted to the project administrator.</p></main>;return <main className="content-page"><p className="eyebrow">RITEVENUE / ADMIN</p><h1>Manage venues & wedding enquiries.</h1><p className="workspace-intro">Check owner authorization, public-display permission, photographs, rental charges and calendar information before publishing a listing.</p><div className="workspace-actions"><a className="primary" href="/admin/enquiries">Wedding enquiry inbox</a><a className="primary" href="/admin/catering">Review catering suppliers</a><AuthSignOut/></div><VenueIntakeReview/><OwnerWorkspace admin adminView/></main>;}
